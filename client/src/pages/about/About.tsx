          ...
          <div className="aboutus-card">
            ...
            <div className="aboutus-body">
              <p>
                ...
                développeurs passionnés, chacun avec ses particularités, mais
                unis par une même envie : créer des expériences numériques qui
                sortent du lot. Voici un peu plus sur qui nous sommes :
              </p>
              <br />
              <p>👨‍💻 Alex : Le papa breton passionné</p>
              <br />
              <p>
                Alex, c’est un développeur qui jongle avec talent entre sa vie
                de papa et ses lignes de code. Amoureux de la Bretagne, il
                s’inspire de ses paysages pour nourrir sa créativité. Fan
                inconditionnel de bande dessinée, il a toujours une nouvelle
                histoire graphique à partager ou un héros préféré à faire
                découvrir. Lorsqu’il n’est pas devant son écran, vous pourriez
                le croiser sur un terrain de sport, où il se dépense avec la
                même énergie qu’il met dans ses projets.
              </p>
              <br />
              ...
              <p>
                ...
                de musique, il joue de la basse et trouve son inspiration dans
                les univers riches de jeux comme Final Fantasy 14. Pour lui, le
